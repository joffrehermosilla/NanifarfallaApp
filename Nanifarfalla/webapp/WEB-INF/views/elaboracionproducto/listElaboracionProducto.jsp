...
<title>Administración de Elaboracion de Producto</title>
...
<body>
	...
	<div class="container theme-showcase" role="main">
		...
		<a href="${urlCreate}" class="btn btn-success" role="button"
			title="Nueva Elaboracion de Producto">Nuevo</a><br> <br>
		<div class="table-responsive">
			<table class="table table-hover table-striped table-bordered">
				<tr>
					<th>Codigo Elaboracion de Producto</th>
					<th>Nombre Elaboracion de Producto</th>
					<th>Temporada Producto</th>
					<th>Clave API</th>
					<th>version</th>
		
				</tr>
				<c:forEach var="elaboracionproductoy" items="${elaboracionproductoy}">
					<tr>
						<td>Tabla Elaboracion de Producto</td>
						...
						<td>${elaboracionproductoy.claveApi}</td>
