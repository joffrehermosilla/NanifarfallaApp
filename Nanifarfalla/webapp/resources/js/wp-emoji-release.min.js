$(document).ready(function () {
    ...
    $('#nov2019SaleAlert .close').click(function( e ){			
      e.preventDefault();			
      Cookies.set('nov2019SaleAlert', 'closed', { expires: 30 });			
    });			

    if(Cookies.get('nov2019SaleAlert') !== 'closed') {			
      $('#nov2019SaleAlert').removeClass('d-none');			
    }
